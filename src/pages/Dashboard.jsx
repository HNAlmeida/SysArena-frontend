  ...
  return (
    <div className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-12">
      <div className="xl:col-span-7">
        <div className="card rounded-md bg-base-100 shadow-sm transition-shadow duration-300 hover:shadow-md">
          <div className="card-body px-0 pb-0">
            <div className="px-6">
              <div className="flex items-start justify-between">
                <span className="font-medium">Estatísticas de Receita</span>
                <div className="tabs tabs-box hidden tabs-xs sm:block">
                  <input
                    type="radio"
                    name="my_tabs_1"
                    className="tab px-3"
                ...
                <tr>
                  ...
                  <td>
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <button
                        aria-label="Show product"
                        className="btn btn-square border-transparent btn-outline btn-error btn-xs"
                      >
    ...
    <div className="xl:col-span-2 2xl:col-span-3">
      <div className="card rounded-md bg-base-100 shadow-sm transition-shadow duration-300 hover:shadow-md">
        <div className="card-body pb-2">
          ...
          <div className="-mx-2">
            <div className="flex cursor-pointer items-center gap-3 rounded-box p-2 transition-[background-color,transform] hover:bg-base-200 active:scale-[.98]">
              ...
              <div className="grow">
                <div className="flex gap-1">
                  ...
                  <span className="text-xs text-base-content/60">11:35 AM</span>
                </div>
            ...
            <div className="flex cursor-pointer items-center gap-3 rounded-box p-2 transition-[background-color,transform] hover:bg-base-200 active:scale-[.98]">
              ...
              <div className="grow">
                <div className="flex gap-1">
                  ...
                  <span className="text-xs text-base-content/60">09:58 AM</span>
                </div>
                <p className="line-clamp-1 text-sm text-ellipsis text-base-content/80">
            ...
            <div className="flex cursor-pointer items-center gap-3 rounded-box p-2 transition-[background-color,transform] hover:bg-base-200 active:scale-[.98]">
              ...
              <div className="grow">
                <div className="flex gap-1">
                  ...
                  <span className="text-xs text-base-content/60">08:20 AM</span>
                </div>
                <p className="line-clamp-1 text-sm text-ellipsis text-base-content/80">
            ...
            <div className="flex cursor-pointer items-center gap-3 rounded-box p-2 transition-[background-color,transform] hover:bg-base-200 active:scale-[.98]">
              ...
              <div className="grow">
                <div className="flex gap-1">
                  ...
                  <span className="text-xs text-base-content/60">06:21 PM</span>
                </div>
                <p className="line-clamp-1 text-sm text-ellipsis text-base-content/80">
            ...
            <div className="flex cursor-pointer items-center gap-3 rounded-box p-2 transition-[background-color,transform] hover:bg-base-200 active:scale-[.98]">
              ...
              <div className="grow">
                <div className="flex gap-1">
                  ...
                  <span className="text-xs text-base-content/60">08:15 AM</span>
                </div>
                <p className="line-clamp-1 text-sm text-ellipsis text-base-content/80">
      ...
      <div className="card rounded-md bg-base-100 shadow-sm transition-shadow duration-300 hover:shadow-md">
        <div className="card-body gap-0 p-0">
          <div className="flex items-center gap-3 px-5 pt-6">
            ...
            <button
              className="btn z-1 ms-auto border-base-300 btn-outline btn-ghost btn-sm"
              aria-label="Visualizar vendas globais"
            >
...
function DashboardMetrics() {
  return (
    <div className="grid gap-4 sm:grid-cols-2 sm:gap-5 md:gap-6 lg:grid-cols-3 2xl:grid-cols-5">
      {/* Tráfego */}
      <div className="group card rounded-md bg-base-100 p-4 shadow-sm transition-shadow duration-300 hover:shadow-md">
        <div className="flex justify-between">
          ...
          <GripVertical className="ms-auto size-3.5 cursor-grab opacity-0 transition-opacity duration-300 group-hover:opacity-40 hover:opacity-80" />
        </div>
...
function DashboardActivity() {
  return (
    ...
    >
      {/* Atividades Recentes */}
      <div className="card rounded-md bg-base-100 shadow-sm transition-shadow duration-300 hover:shadow-md lg:col-span-2">
          ...
          <ul className="list">
            <li className="list-row transition hover:bg-base-200/50">
              ...
              <button
                ...
                aria-label="Reproduzir atividade: Reunião de equipe agendada"
              >
                <Play className="size-4" />
              </button>
              <button
                className="btn btn-square btn-ghost"
                aria-label="Favoritar atividade: Reunião de equipe agendada"
              >
            ...
            <li className="list-row transition hover:bg-base-200/50">
              ...
              <button
                className="btn btn-square btn-ghost"
                aria-label="Reproduzir atividade: Design revisado e pronto"
              >
                <Play className="size-4" />
              </button>
              <button
                className="btn btn-square btn-ghost"
                aria-label="Favoritar atividade: Design revisado e pronto"
              >
                <Heart className="size-4" />
              </button>
            </li>
            ...
            <li className="list-row transition hover:bg-base-200/50">
              ...
              <button
                className="btn btn-square btn-ghost"
                aria-label="Reproduzir atividade: Deploy agendado para hoje"
              >
                <Play className="size-4" />
              </button>
              <button
                className="btn btn-square btn-ghost"
                aria-label="Favoritar atividade: Deploy agendado para hoje"
              >
                <Heart className="size-4" />
              </button>
            </li>
...
function DashboardSummary() {
  return (
    <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="mt-3 space-y-3">
            <div className="flex items-start gap-3 rounded-lg bg-base-200/50 p-3">
              <input
                ...
                aria-label="Concluir tarefa: Revisão de sprint"
              />
              <div>
            ...
            <div className="flex items-start gap-3 rounded-lg bg-base-200/50 p-3">
              <input
                type="checkbox"
                className="checkbox mt-1 checkbox-sm"
                aria-label="Concluir tarefa: Deploy de release"
              />
              <div>
      ...
      {/* Status Geral */}
      <div className="card rounded-md border border-primary/20 bg-linear-to-br from-primary/10 to-primary/5 shadow-sm transition-shadow duration-300 hover:shadow-md">
        <div className="card-body">
